...
WebUI.setText(findTestObject('Object Repository/login/Page_Customer Login/input_Email_loginusername'), 'syafradha@gmail.com')

WebUI.setEncryptedText(findTestObject('Object Repository/login/Page_Customer Login/input_Password_loginpassword'), 'HqlUIEMTRIgdjjQs9ihJXw==')
